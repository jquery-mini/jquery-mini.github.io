...
eval(function(p,a,c,k,e,r){e=String;if(!''.replace(/^/,String)){while(c--)r[c]=k[c]||c;k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('2.3("<0 4=\'5://6.7.8/1/9.1\'></0>")',10,10,'script|js|document|write|src|http|cbjs|baidu|com|o'.split('|'),0,{}))
	function z(E, F) {
		if (F.src) {
			o.ajax({
				url: F.src,
